...
//Once you are done, create another prototype(d) function called search, it will take just one argument which is the number you are to find. 
...
//The .search function should implement the binary search algorithm, each time you iterate, you should increase the count, to test how 
//efficient your implementation is.
'use strict';
var binarySearch = require('../app/binarysearch.js');
(function(){
